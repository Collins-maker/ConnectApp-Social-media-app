...
const {getAllUsers, getUsersByUsername, getUsersFollowers, followUser,unfollowUser, getUsersByUserId, updateUserProfile} =require('../controllers/userControllers');
...
userRoutes.post('/unfollow/:user_id', unfollowUser);
